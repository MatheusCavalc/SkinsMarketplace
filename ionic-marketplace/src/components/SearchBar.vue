...
<template>
    ...
    <!-- Only Screen Mobile -->
    <!-- Icon Cart -->
    <div v-if="cartInfos.cartItems.length > 0" class="fixed z-30 bottom-20 right-4 lg:hidden">
        <RouterLink to="/cart"
            class="relative flex items-center justify-center gap-1 p-4 mt-3 text-sm text-white bg-black rounded-full">
