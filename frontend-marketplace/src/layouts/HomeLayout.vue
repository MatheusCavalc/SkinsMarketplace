            ...
            <div class="flex lg:order-1">
                ...
                <div class="hidden lg:block">
                    <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="https://w7.pngwing.com/pngs/384/161/png-transparent-tom-clancy-s-rainbow-six-siege-tom-clancy-s-rainbow-six-vegas-2-tom-clancy-s-rainbow-6-patriots-tom-clancy-s-rainbow-six-3-raven-shield-rainbow-six-tom-clancy-s-rainbow-six.png" class="h-8" alt="Flowbite Logo">
